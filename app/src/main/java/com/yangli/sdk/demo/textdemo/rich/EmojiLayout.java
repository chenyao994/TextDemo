...
import com.yangli.sdk.demo.textdemo.adapter.ExpressionPagerAdapter;
import com.yangli.sdk.demo.textdemo.adapter.SmileImageExpressionAdapter;
...
public class EmojiLayout extends LinearLayout {
    ...
    private void initViews() {
        ...
        for (int i = 0; i < views.size(); i++) {
            ...
            if (i == 0) {
                imageFaceViews[i].setImageDrawable(focusIndicator);
            } else {
                imageFaceViews[i].setImageDrawable(unFocusIndicator);
            }
    ...
    private class GuidePageChangeListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageSelected(int arg0) {
            for (int i = 0; i < imageFaceViews.length; i++) {
                imageFaceViews[arg0].setImageDrawable(focusIndicator);
                if (arg0 != i) {
                    imageFaceViews[i].setImageDrawable(unFocusIndicator);
                }
            }
